...
label: WorkflowNo_13
doc: A workflow including the tool(s) XTandem, mzRecal, Comet, PeptideProphet, ProteinProphet, protXml2IdList, gProfiler.
...
steps:
  ...
  gProfiler7:
    run: https://raw.githubusercontent.com/Workflomics/containers/docker/cwl/tools/gProfiler/gProfiler.cwl
    in:
      gProfiler_in_1: protXml2IdList6/protXml2IdList_out_1
    out: [gProfiler_out_1, gProfiler_out_2]
outputs:
  output1:
    type: File
